...
var MediaPlayer = {
    init() {
        ...
        this.uploadFold = document.getElementById("upfolder");
        ...
        let fullscreenchange = (e) => {
            document.documentElement.classList.toggle("fullscreen", !!(document.fullscreenElement ||
